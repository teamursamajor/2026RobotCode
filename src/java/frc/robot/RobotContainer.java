...
import frc.robot.commands.Algae.AlgaeDecreaseAngle;
import frc.robot.commands.Algae.AlgaeMotorStart;

import frc.robot.commands.Algae.AlgeaIncreaseAngle;
...
import frc.robot.commands.Coral.CoralChangeAngle;
import frc.robot.commands.Coral.IntakeAngle;
import frc.robot.commands.Coral.OutakeAngle;
import frc.robot.commands.Coral.PullCoral;
import frc.robot.commands.Coral.PushCoral;
import frc.robot.commands.Coral.TroughOutake;
import frc.robot.commands.Coral.autoIntakeAngle;
import frc.robot.commands.Drive.DriveLeftFast;
import frc.robot.commands.Drive.DriveRightFast;
...
public class RobotContainer {
  ...
  private AlgaeSubsystem m_Algae = new AlgaeSubsystem();
